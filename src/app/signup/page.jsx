...
export default function Signup() {
    ...
    const handleFormSubmit = (e) => {
        ...
        localStorage.setItem("user", JSON.stringify({ username: data["name"], email: data["email"] }));
        setError(null);
      ...
      <div className="w-1/2 sm:w-1/2 h-auto flex justify-center items-center bg-red-500 hidden sm:block">
        ...
        <div className="signup-form flex flex-col sm:w-1/4 w-11/12">
            ...
            <form className="flex flex-col gap-6 mt-8" onSubmit={handleFormSubmit}>
                <input type="text" name="name" placeholder="Name" className="border-b border-gray-300 py-2 outline-none" />
                ...
                <input type="password" name="confirm-password" placeholder="Confirm Password" className="border-b border-gray-300 py-2 outline-none" />
                <p className={`${error ? "block" : "hidden"} text-red-400 `}>&#9888; {error}</p>
