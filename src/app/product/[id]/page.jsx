...
import { addToCart, addToCartHandle, isInCart } from "@/lib/cart";
            ...
            <div className="current-product flex flex-col md:flex-row gap-24 mt-6 mb-20">
                ...
                <div className="details flex flex-col items-stretch gap-4 md:w-2/5 w-full">
                    ...
                    <div className="flex flex-col md:flex-row gap-5 items-center justify-between">
                        ...
                        <button className="px-10 py-2 text-xs text-white font-medium rounded cursor-pointer w-full" style={{backgroundColor: "#DB4444"}} onClick={e => addToCartHandle(e, id, product.title, quantity, product.price, product.image)}>Buy Now</button>
